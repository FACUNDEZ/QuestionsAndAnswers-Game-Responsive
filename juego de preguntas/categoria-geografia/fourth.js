...
async function getData() {
    ...
    try {
        ...
        firstOption.innerHTML += data.questions[3].respuesta_incorrecta3
        secondOption.innerHTML += data.questions[3].respuesta_incorrecta1
        thirdOption.innerHTML += data.questions[3].respuesta_incorrecta2
        fourthOption.innerHTML += data.questions[3].respuesta_correcta
    }
    catch (error) {
        console.log(error)
    }
