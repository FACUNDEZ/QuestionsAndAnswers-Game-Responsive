...
async function getData() {
    ...
    try {
        ...
        question.innerHTML = data.questions[2].pregunta
        firstOption.innerHTML += data.questions[2].respuesta_incorrecta2
        secondOption.innerHTML += data.questions[2].respuesta_correcta
        thirdOption.innerHTML += data.questions[2].respuesta_incorrecta1
        fourthOption.innerHTML += data.questions[2].respuesta_incorrecta3
    }
    catch (error) {
        console.log(error)
    }
...
function verAnswer() {
    const correctOption = secondOption;
