...
async function getData() {
    ...
    try {
        ...
        firstOption.innerHTML += data.questions[1].respuesta_incorrecta3
        secondOption.innerHTML += data.questions[1].respuesta_incorrecta1
        thirdOption.innerHTML += data.questions[1].respuesta_correcta
        fourthOption.innerHTML += data.questions[1].respuesta_incorrecta2
    }
    catch (error) {
        console.log(error)
    }
