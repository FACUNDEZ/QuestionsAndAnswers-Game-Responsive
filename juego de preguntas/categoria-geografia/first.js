...
async function getData() {
    ...
    try {
        ...
        question.innerHTML = data.questions[0].pregunta
        firstOption.innerHTML += data.questions[0].respuesta_correcta
        secondOption.innerHTML += data.questions[0].respuesta_incorrecta1
        thirdOption.innerHTML += data.questions[0].respuesta_incorrecta3
        fourthOption.innerHTML += data.questions[0].respuesta_incorrecta2
    }
    catch (error) {
        console.log(error)
    }
